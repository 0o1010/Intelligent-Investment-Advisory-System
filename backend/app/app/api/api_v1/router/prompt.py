...
用户信息如下：
1.  **年龄 (age)**：{例如：35岁}
2.  **家庭状况 (family_status)**：{例如：已婚，有一个5岁孩子，父母健康}
3.  **职业与收入稳定性 (occupation_income_stability)**：{例如：互联网大厂工程师，收入较高且相对稳定，未来几年预计收入持续增长}
...
8.  **负债情况 (liabilities)**：{例如：房贷100万，月供8000元；车贷10万，月供3000元；无其他大额负债}
